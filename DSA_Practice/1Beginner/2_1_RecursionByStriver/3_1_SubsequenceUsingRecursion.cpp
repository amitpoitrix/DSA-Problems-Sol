...
// Using Recursion - Here we have choice in each element/character either to choose it or 
// not to choose it so two recursion calls will be used
// TC - O(n*(2^n)) - As starting n is due to for inner loop for printing each subsequence
